...
#include <memory>
#include "../../../../QtSOAP-master/src/qtsoap.h"
...
void QtSoapHttpTransport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QtSoapHttpTransport *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QtSoapHttpTransport::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtSoapHttpTransport::responseReady)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QtSoapHttpTransport::*)(const QtSoapMessage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtSoapHttpTransport::responseReady)) {
                *result = 1;
                return;
            }
...
QT_INIT_METAOBJECT const QMetaObject QtSoapHttpTransport::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QtSoapHttpTransport.data,
    qt_meta_data_QtSoapHttpTransport,
    qt_static_metacall,
    nullptr,
    nullptr
} };
